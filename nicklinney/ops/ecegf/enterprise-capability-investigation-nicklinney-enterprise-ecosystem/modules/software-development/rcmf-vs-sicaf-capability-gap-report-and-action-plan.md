---
title: NickLinney.SoftwareDevelopment - RCMF vs. SICAF Capability Gap Report and Action Plan
description: NickLinney.SoftwareDevelopment - RCMF vs. SICAF Capability Gap Report and Action Plan
published: true
date: 2026-07-28T06:26:52.166Z
tags: 
editor: markdown
dateCreated: 2026-07-28T06:26:52.166Z
---

# NickLinney.SoftwareDevelopment - RCMF vs. SICAF Capability Gap Report and Action Plan
...
| Module | NickLinney.SoftwareDevelopment |
...
| Field | Position |
| --- | --- |
| Current evidentiary conclusion | Standards and planning intent are visible, but the corpus does not prove an actively operating software-development governance capability. |
...
| --- | --- | --- | --- |
| 0-30 days | Convert guides and implied standards into controlled templates and procedures | Capability owner | Scope, ownership, and governance baseline are published |
| 0-30 days | Define minimum evidence requirements for this module | Governance Lead | Evidence standard is documented |
| 31-60 days | Establish completion evidence, testing evidence, and release-readiness criteria | Operations Lead | First module evidence pack is available |
| 31-90 days | Run one full governed development case through the module | Capability owner | Review cadence is operating with logged outputs |
